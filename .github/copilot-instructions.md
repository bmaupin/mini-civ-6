This is a mod for Sid Meier's Civilization VI (Civ 6). The overall goal of the mod is to modify the game so that it can be completed in shorter sessions, ideally 1-2 hours.
